...
export default function RouteEdit({ route, onSave }: RouteEditProps) {
    ...
    let [estimatedStartDate, setEstimatedStartDate] = useState(() => {
        let date = new Date(route.estimatedStartTime);
        return toLocalISOString(date);
    })

    let [estimatedSpeed, setEstimatedSpeed] = useState<number | ''>(route.estimatedAverageSpeed ?? '');
    let [pauseInMinutes, setPauseInMinutes] = useState<number | ''>(route.pauseInMinutes ?? '');
